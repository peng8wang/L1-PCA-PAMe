...
for j = 1:numinit
    ...
    P0 = ones(n,K).*sign(randn(n,K)); alpha = 1e-6; beta = 1e2;
    ...
    if run_PAMe == 1
        ...
        [Q_PE, P_PE, time_collect_PE, fval_collect_PE, Q_collect_PE] = PAMe(X, Q0, P0, alpha, beta, opts);
